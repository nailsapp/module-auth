...
$config['email_types'][0]->name             = 'Auth: Verify Email (Generic)';
...
$config['email_types'][1]->name             = 'Auth: Forgotten Password';
...
$config['email_types'][2]->name             = 'Auth: Welcome Email (Generic)';
...
$config['email_types'][3]->name             = 'Auth: Password Updated';
