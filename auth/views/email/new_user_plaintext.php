...
<?=$admin->first_name . ' ' . $admin->last_name?>, an administrator for the <?=APP_NAME?> website, has just
created a new <?=$admin->group->name?> account for you.
<?php } else { ?>
...
Additionally, we would appreciate it if you could verify your email address using the link below, we do this
to maintain the integrity of our database.
