...
<p>
    ...
    <?=anchor('auth/forgotten_password?identifier=' . urlencode($_identifier), 'reset your password')?> using
    the forgotten password facility and please let us know of any fraudulent activity on your account.
</p>