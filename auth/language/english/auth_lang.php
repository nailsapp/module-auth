...
$lang['auth_forgot_success']                      = 'Reset token sent! Please check your email remembering to look in junk and spam folders.';
...
$lang['auth_forgot_code_not_set_email']           = 'Sorry, we were unable to generate a token for the email address %s.';
$lang['auth_forgot_code_not_set_username']        = 'Sorry, we were unable to generate a token for the username %s.';
$lang['auth_forgot_code_not_set']                 = 'Sorry, we were unable to generate a token for that account.';
$lang['auth_forgot_expired_code']                 = 'Sorry, the reset token you are using has expired. You will need to resubmit a password reset request.';
$lang['auth_forgot_invalid_code']                 = 'Sorry, Invalid or expired password reset token.';
