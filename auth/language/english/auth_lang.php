 ...
 **/
    ...
    //  Messages
    $lang['auth_login_ok_welcome']                      = '<strong>Welcome, %s!</strong><br />You last logged in %s.';
    $lang['auth_login_ok_welcome_with_ip']              = '<strong>Welcome, %s!</strong><br />You last logged in %s from IP address %s.';
    $lang['auth_login_ok_welcome_notime']               = '<strong>Welcome, %s!</strong><br />Nice to see you again.';
    ...
    $lang['auth_forgot_email_fail_no_email']            = '<strong>Sorry,</strong> there was a problem sending the email with your reset link. Your account has no email address associated with it, please contact us for assistance.';
    $lang['auth_forgot_email_fail_no_id']               = '<strong>Sorry,</strong> there was a problem sending the email with your reset link. Please try again.';
